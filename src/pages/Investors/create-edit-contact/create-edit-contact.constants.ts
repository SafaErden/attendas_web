...
export const contactValidationSchema = object({
	...
	firstName: string().nullable().required(ERROR_MESSAGES.required('contacts first name', false, false)),
	lastName: string().nullable().required(ERROR_MESSAGES.required('contacts last name', false, false)),
